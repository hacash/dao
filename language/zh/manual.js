module.exports = {
    ...
    learn: [
        "快速了解 Hacash", "理解Hacash的重点技术和核心价值",
        "什么是Hacash?", 
        `<p>Hacash是一个基于PoW机制和可编程的加密货币系统。它是第一个同时实现去中心化和购买力稳定的加密货币。整个货币体系由HACD，BTC，HAC三种不同特质的PoW币组成，其中HACD是首个基于PoW机制的NFT和生成艺术。</p>
    ...
    coins3: [
        `三个 PoW 币在一条链上的金融生态`,
        `<p>Hacash由三个不同特质的PoW币，HAC，HACD和BTC组成。如果我们将HACD，BTC和HAC按从左往右的顺序排列，可以得出流动性将从低变高，价值稳定性将从低变高，投机性将由强到弱。</p>
        <p>他们组成的货币体系就像黄金、白银、铜作为主流货币的时期一样，将由自由市场来驱动三者不同货币的相互调节和使用。</p>
        ...
        `<ul>
            ...
            <li><b>生产规则</b>：遵循斐波那契先增后减的原理，5分钟一个区块，一日产出288个区块。
                <p>2019年2月4日开始产出第一个区块。</p>
                <p>第一阶段，每 10 万个区块约 0.95 年调整一次数量，奖励逐渐上升；
                2020年区块奖励为1个HAC，2021年区块奖励为2个HAC，2022年为3个HAC，2023年为5个HAC，2024年为8个HAC。</p>
                <p>第二阶段，每 100 万个区块约 9.5 年调整一次数量，奖励逐渐下降；
                进入第二个阶段，2025年为8个HAC持续十年时间，到2035年开始为5个HAC，2045年为3个HAC，2055年为2个HAC，2065年为1个HAC，2075年为1个HAC持续十年。</p>
                <p>第三阶段，最终恒定在每区块奖励1个HAC。
                在进入第三阶段前共66年，区块总奖励为2200万。
                可以通过查看社区工具Hacash区块奖励倒计时来查看下一次区块奖励变化的时间。</li>
            <li><b>生产方式</b>：HAC遵循X16RS算法，该算法抗ASIC矿机。从CPU开始挖矿，目前有团队研发出GPU挖矿锄头。</li>
            <li><b>当前流通</b>：约100万总产量，销毁了51万。统计数据处于变化之中，具体可查看<a href="https://explorer.hacash.org">区块浏览器</a>。</li>
        </ul>`,
        
        `<ul>
            <li><b>主要用途</b>：调节HAC数量，价值存储，艺术创作，身份标识</li>
            <li><b>分割性</b>：不可分割，每一个HACD都由6个字母组成</li>
            <li><b>数量</b>：6个字母从16个字母"WTYUIAHXVMEKBSZN"中来，且不重复，所以总量为16^6=16,777,216个</li>
            <li><b>数量调节</b>：可根据供需停止产出</li>
            <li><b>生产规则</b>：HACD的产出需要通过挖矿和竞价。5个区块产出一个，平均为25分钟。5个区块的时间内竞价最高的HACD被打包。但HACD的挖矿难度会不断升高且不会降低，可以根据市场情况随时停止产出。每日最多产出 58枚，每年产出约 21000 枚。假设投入足够多算力，预计2100年最多有170万不到的HACD被挖出。</li>
            <li><b>生产方式</b>：HACD遵循X16RS+钻石挖掘算法，该算法抗ASIC矿机，目前以CPU挖矿为主。如果多个矿工同时竞争挖出则需要链上竞价。</li>
            <li><b>当前流通</b>：7万多，具体可查看<a href="https://explorer.hacash.org">区块浏览器</a>。</li>
        </ul>`,

        `<ul>
            <li><b>主要用途</b>：调节HAC数量，扩展BTC应用生态</li>
            ...
            <li><b>生产方式</b>：Hacash和比特币具有相同的账户模型。用一个比特币地址将整数个BTC转入一个比特币主网无私钥的销毁地址，转移前的地址在Hacash中生成BTC</li>  
            <li><b>当前流通</b>：未流通</li>
        </ul> `,
    ],
    ...
    start: [
        "简单快速的入门操作手册",
        `<p>当你对 Hacash 有了大致的了解，你可以先通过交易，创建账户和挖矿等方式参与 Hacash 。</p>`,
        `<p>目前 Hacash 的钱包主要依赖于社区开发的钱包，这些钱包经过长时间的验证，聚集在 <a href="https://wallet.hacash.org"></a> 中，主要分为4种。</p>
        <ul>
            <li>
                <b>一键生成地址</b><br/>
    ...
    community: [
        ...
        `<p>由于该项目没有代币激励，没有预挖，也没有团队。意味着没有任何额外的资金可以推动这个项目。只能依靠大家众筹来推动这个项目。目前社区已经众筹了两个交易所和一篇媒体文章。目前众筹一般在HacashTalk中发起。我们正在提议一个社区众筹的标准执行方案。
        </p>`,
    ...
    resource: [
        "了解更多扩展内容和详尽资料",
        `<ul>
            <li>Hacash最早的网站：<a href="https://hacash.org/ "></a></li>
            <li>用货币的角度理解Hacash：<a href="https://hacash.money/"></a></li>
            <li>理解HACD：<a href="https://hacd.art/"></a></li>
            <li>聚合Hacash所有信息：<a href="https://hacashdao.org/"></a></li>
            <li>专注Hacash新闻媒体：<a href="https://hacashnews.com/"></a></li>
            <li>Hacash.Diamonds的Medium：<a href="https://medium.com/hacash-diamonds"></a></li>
            <li>Hacash.com的Substack：<a href="https://hacashcom.substack.com/"></a></li>
            <li>Hacash.com的精通Hacash：<a href="https://master.hacash.com/"></a></li>
        </ul>`,
        `<ul>
            <li>Hacash扩展项目：<a href="https://hacash.com/"></a></li>
            <li>专注Hacash服务的项目：<a href="https://hacash.diamonds/"></a></li>
            <li>Hacash矿池项目：<a href="https://hacpool.com/"></a></li>
            <li>专注Hacash新闻媒体：<a href="https://hacashnews.com/"></a></li>
            <li>Hacash矿池（暂停）：<a href="https://hacashpool.com/"></a></li>
            <li>Hacash市场（暂停）：<a href="http://www.hacashmarket.com/"></a></li>
            <li>Hacash跨链（暂停）：<a href="HACSwap"></a></li>
        </ul>`,
        `<ul>
            ...
            <li>HACD 竞价工具: <a href="https://hacpool.com/bidding"></a></li>
            <li>HACD HIP-5 类别分析: <a href="https://www.hacash.diamonds/types"></a></li>
        </ul>`,
        `<p></p>
        <ul>
