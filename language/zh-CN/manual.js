module.exports = {
    ...
    coins3: [
        ...
        `<ul>
            ...
            <li><b>生产规则</b>：遵循斐波那契先增后减的原理，5分钟一个区块，一日产出288个区块。</li>
        </ul>
        ...
        可以通过查看社区工具Hacash区块奖励倒计时来查看下一次区块奖励变化的时间。</p>
        <p>生产方式：HAC遵循X16RS算法，该算法抗ASIC矿机。从CPU开始挖矿，目前有团队研发出GPU挖矿锄头。</p>
        <p>当前流通：约100万总产量，销毁了51万。统计数据处于变化之中，具体可查看<a href="https://explorer.hacash.org">区块浏览器</a>。</p>`,
        ...
        <p>生产方式：HACD遵循X16RS+钻石挖掘算法，该算法抗ASIC矿机，目前以CPU挖矿为主。如果多个矿工同时竞争挖出则需要链上竞价。</p>
        <p>当前流通：7万多，具体可查看<a href="https://explorer.hacash.org">区块浏览器</a>。</p>`,
        ...
        `<ul>
            ...
            <li><b>生产规则</b>：单向转移BTC可以获得HAC的风险补偿</li>
        </ul>        
        <p>假如您是第300笔比特币单向转移，您的排名将是10，您将获得2048HAC的奖励，锁定期为2周，每周释放 1024 HAC。</p>
        <p>生产方式：Hacash和比特币具有相同的账户模型。用一个比特币地址将整数个BTC转入一个比特币主网无私钥的销毁地址，转移前的地址在在Hacash中生成BTC。</p>`,
    ],
